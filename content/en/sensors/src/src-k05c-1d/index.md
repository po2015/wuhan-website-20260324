...
slug: src-k05c-1d
aliases:
- /complete-products/radar/src-k05c-1d/
...
hero_image: /ref-image/SRC-K05C-1D.png
...
- title: Operational advantage 02
  text: 90 degree azimuth coverage and 80 degree elevation coverage for wide-area
    surveillance.
...
- model: SRC-X05E-1D
  ...
  relation: Comparable mission-focused model with a similar waveform approach.
---
SRC-K05C-1D Surveillance Radar is positioned for low-altitude surveillance, critical site protection, and counter-uas early warning projects where operators need Ku band Pulse Doppler sensing and a readable site-warning layer. The 2d electronic scanning (single-face aesa) architecture supports structured deployment planning and downstream response coordination.

SRC-K05C-1D Surveillance Radar is a Ku band Pulse Doppler surveillance radar designed for drone detection. It uses 2d electronic scanning (single-face aesa) for practical security monitoring and response workflows.
