...
- name: Human Detection
  value: 16 km (0.5 m² reference target)
- name: Vehicle Detection
  value: 22.6 km (2 m² reference target)
- name: Vessel Detection
  value: 33.8 km (10 m² reference target)
- name: Nominal Class
  value: 16 km
...
- name: Operating Temperature
  value: -40 to 55 °C
- name: Power Input
  value: DC 18~32V (with AC 220V to DC 24V adapter)
...
- image: /images/sensors/deployment/radar-deployment-port-crane-vessel-channel.png
  title: Port and maritime watch
  alt: Commercial port channel with cranes, vessel traffic, and waterside working area
