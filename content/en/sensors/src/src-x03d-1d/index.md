...
description: X band Pulse Doppler surveillance radar for drone detection with up to
  5 km instrumented range.
kicker: SRC Radar
layout: src-detail-sample
slug: src-x03d-1d
aliases:
- /complete-products/radar/src-x03d-1d/
...
hero_image: /ref-image/SRC-X03D-1D.png
