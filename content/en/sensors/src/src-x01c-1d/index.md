...
description: X band Pulse Doppler surveillance radar for drone detection with up to
  3 km instrumented range.
kicker: SRC Radar
layout: src-detail-sample
slug: src-x01c-1d
aliases:
- /complete-products/radar/src-x01c-1d/
...
hero_image: /ref-image/SRC-X01C-1D.png
